...
@clinic_views.route('/clinic/add_medical_records', methods=['GET', 'POST'])
...
def edit_medical_record(MID):
    ...
    if form.validate_on_submit():
        ...
        medicalrecord.time=form.time.data
        medicalrecord.update_time=form.update_time.data
    ...
    form.time.data = medicalrecord.time
    form.update_time.data = medicalrecord.update_time
